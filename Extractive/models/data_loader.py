...
class Batch(object):
    ...
    def __init__(self, data=None, device=None,  is_test=False):
        ...
        if data is not None:
            ...
            setattr(self, 'weight', weight.to(device))
...
class DataIterator(object):
    ...
    def preprocess(self, ex, is_test):
        ...
        if is_test:
            return src, labels, segs, clss, src_txt, tgt_txt, index, weight
        else:
            return src, labels, segs, clss, weight
